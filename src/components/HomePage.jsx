                ...
                <div className="howWeWork">
                    <div className="grid-item">
                        <div className="image-container">
                            <img src='https://images.unsplash.com/photo-1496902526517-c0f2cb8fdb6a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80' alt="grid item" />
                        </div>
                    ...
                    <div className="grid-item">
                        <div className="image-container">
                            <img src='https://images.pexels.com/photos/1109541/pexels-photo-1109541.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940' alt="grid item" />
                        </div>
                        <div className="explain">
                            <h3>Design</h3>
                    ...
                    <div className="grid-item">
                        <div className="image-container">
                            <img src='https://wfdesignbuild.com/img/wfdb_step_build.png' alt="grid item" />
                        </div>
                        <div className="explain">
                            <h3>Construct</h3>
